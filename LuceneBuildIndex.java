...
public class LuceneBuildIndex {
    ...
    public static void main( String[] args ) {
        try {
            ...
            String pathCorpus = "C:\\Users\\beyza\\git\\LuceneTutorial\\example_corpus.gz";
            String pathIndex = "C:\\Users\\beyza\\git\\LuceneTutorial\\example_index_lucene";
            ...
            Analyzer analyzer = new Analyzer() {
                ...
                protected TokenStreamComponents createComponents( String fieldName ) {
                	...
                	a.add("to");
                	a.add("the");
                	CharArraySet stopWordsSet = new CharArraySet( a, false);
                    ...
                    // classic simiarity icin indexleme
                     ts = new TokenStreamComponents(ts.getSource(), new DelimitedTermFrequencyTokenFilter(ts.getTokenStream(),' '));
                    // hocanın yazdığı filtre
